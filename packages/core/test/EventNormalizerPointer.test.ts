        ...
        describe('pointer', () => {
            describe('set range', () => {
                it('click outside do nothing (ubuntu chrome)', async () => {
                    ...
                    setRange(ctx.div.firstChild, 1, ctx.div.firstChild, 1);
                    setRange(ctx.div.firstChild, 1, ctx.div.firstChild, 2);
                ...
                it('right click outside do nothing (ubuntu chrome)', async () => {
                    ...
                    setRange(ctx.div.firstChild, 0, ctx.div.firstChild, 2);
                    await nextTick();
                    await nextTick();
                    expect(ctx.eventBatches).to.deep.equal([]);
                });
            ...
            describe('select all', () => {
                it('mouse select (ubuntu chrome)', async () => {
                    ...
                    await nextTick();
                    await nextTick();
                    setRange(ctx.editable, 0, ctx.div.firstChild, 3);
                    await nextTick();
                    await nextTick();
