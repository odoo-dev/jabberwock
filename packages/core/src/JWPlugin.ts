...
import { RenderingEngine, RenderingEngineIdentifier, Renderer } from './RenderingEngine';
...
export class JWPlugin {
    ...
    readonly renderers: Record<RenderingEngineIdentifier, Constructor<Renderer>[]>;
    name: string;
    editor: JWEditor;
