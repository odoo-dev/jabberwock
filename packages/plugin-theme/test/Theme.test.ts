        ...
        expect(container.innerHTML).to.equal(
            [
                '<jw-editor>',
                    '<jw-toolbar>',
                        '<jw-group>',
                            '<button name="theme-default" aria-pressed="true" class="pressed">Theme: default</button>',
                            '<button name="theme-second" aria-pressed="false">Theme: second</button>',
                            '<button name="theme-third" aria-pressed="false">Super theme</button>',
                        '</jw-group>',
                    '</jw-toolbar>',
        ...
        expect(container.innerHTML).to.equal(
            [
                '<jw-editor>',
                    '<jw-toolbar>',
                        '<jw-group>',
                            '<button name="theme-default" aria-pressed="false" class="">Theme: default</button>',
                            '<button name="theme-second" aria-pressed="false">Theme: second</button>',
                            '<button name="theme-third" aria-pressed="true" class="pressed">Super theme</button>',
                        '</jw-group>',
                    '</jw-toolbar>',
